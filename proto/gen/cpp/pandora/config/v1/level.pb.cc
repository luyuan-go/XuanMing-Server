  ...
  return ParseTableT_{
    {
      ...
      {::_pbi::TcParser::FastV32S2,
       {400, 17, 0,
        PROTOBUF_FIELD_OFFSET(LevelRow, _impl_.prepare_duration_seconds_)}},
...
const char descriptor_table_protodef_pandora_2fconfig_2fv1_2flevel_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "gPool\022O\n\030prepare_duration_seconds\030\022 \001(\rB"
...
::uint8_t* PROTOBUF_NONNULL LevelRow::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00004000U)) {
    if (this_._internal_battle_duration_seconds() != 0) {
      target = stream->EnsureSpace(target);
      target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
          14, this_._internal_battle_duration_seconds(), target);
    }
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00020000U)) {
    if (this_._internal_prepare_duration_seconds() != 0) {
      target = stream->EnsureSpace(target);
      target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
          18, this_._internal_prepare_duration_seconds(), target);
    }
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00040000U)) {
    if (this_._internal_settle_duration_seconds() != 0) {
      target = stream->EnsureSpace(target);
      target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
          19, this_._internal_settle_duration_seconds(), target);
    }
  }
    ...
    if (CheckHasBit(cached_has_bits, 0x00020000U)) {
      if (this_._internal_prepare_duration_seconds() != 0) {
        total_size += 2 + ::_pbi::WireFormatLite::UInt32Size(
                                        this_._internal_prepare_duration_seconds());
      }
    }
    // uint32 settle_duration_seconds = 19 [json_name = "settleDurationSeconds", (.pandora.config.v1.excel_col) = "\347\273\223\347\256\227\346\227\266\351\225\277", (.pandora.config.v1.excel_default) = "0"];
    if (CheckHasBit(cached_has_bits, 0x00040000U)) {
...
void LevelRow::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00070000U)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00020000U)) {
      if (from._internal_prepare_duration_seconds() != 0) {
        _this->_impl_.prepare_duration_seconds_ = from._impl_.prepare_duration_seconds_;
      }
    }
    if (CheckHasBit(cached_has_bits, 0x00040000U)) {
